package by.timofeyzaytsev.textpolish.feature.textpolish.create_task;

import by.timofeyzaytsev.textpolish.features.textpolish.create_task.CreateTextPolishTaskHandler;
import by.timofeyzaytsev.textpolish.features.textpolish.create_task.CreateTextPolishTaskMapper;
import by.timofeyzaytsev.textpolish.features.textpolish.create_task.CreateTextPolishTaskRequest;
import by.timofeyzaytsev.textpolish.features.textpolish.create_task.CreateTextPolishTaskResponse;
...
public class CreateProcessTextPolishTaskHandlerTest {
    ...
    void createTextPolishTask_WhenRequestIsValid_ShouldReturnCreateTextPolishTaskResponse() {
        ...
        when(createTextPolishTaskMapper.toTextPolishTask(request)).thenReturn(task);
        ...
        verify(createTextPolishTaskMapper, times(1)).toTextPolishTask(request);
