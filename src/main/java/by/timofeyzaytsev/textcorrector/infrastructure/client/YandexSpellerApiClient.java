package by.timofeyzaytsev.textcorrector.infrastructure.client;

import by.timofeyzaytsev.textcorrector.features.textpolish.task_polish.YandexSpellerCheckResponse;
...
public interface YandexSpellerApiClient {
